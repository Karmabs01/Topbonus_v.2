(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_cd9fa2._.js", {
...
const TopBrands = ()=>{
   ...
   */ const categoryTabs = {
    ...
    // Состояние для активного таба; по умолчанию выбран "trendsetting"
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("trendsetting");
    // Используем SWR для получения брендов с учётом выбранной категории.
    // Предполагается, что функция getBrands поддерживает второй параметр для категории.
...
_s(TopBrands, "I98CuGdEtsWEc9Nt6bkNKyBvT50=", false, function() {
    return [
...
//# sourceMappingURL=_cd9fa2._.js.map