    ...
    <div className="pt-16">
      <div className="main__container flex justify-between items-center inner-top-block h-full relative">
        <div className="flex flex-col lg:basis-[60%] inner-text-block ">
          ...
          <p className="text-white mt-5">{t("Interested in gaming at online casinos that welcome Maestro transactions? Let Topbonus steer you to the ideal Maestro-friendly casino for you.")}</p>
          {/* <Subscribe /> */}
        </div>
        <div >
